    ...
    <div className="flex flex-col h-screen bg-background text-foreground">
      ...
      <header className="h-14 border-b flex items-center px-6 bg-card/50 backdrop-blur-sm gap-4 shrink-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span className="font-bold text-base">Gestion de Portefeuille</span>
          <span className="text-xs text-muted-foreground bg-secondary/50 px-2 py-0.5 rounded-full">Module 2</span>
        </div>
